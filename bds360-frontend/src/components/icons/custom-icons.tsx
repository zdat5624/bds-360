...
export const ZaloIcon = ({ className = "", ...props }: React.SVGProps<SVGSVGElement>) => (
    <svg
        ...
        {...props}
    >
        {/* Nền xanh: Sử dụng currentColor để ăn theo class text-... của Tailwind */}
        <path
            fillRule="evenodd"
            clipRule="evenodd"
        ...
        {/* Bóng đổ nhẹ bên trong nền: Dùng màu đen với opacity thấp */}
        <path
            opacity="0.12"
            fillRule="evenodd"
            clipRule="evenodd"
        ...
        {/* Hình khối cái bong bóng: Giữ màu Trắng cố định */}
        <path
            fillRule="evenodd"
            clipRule="evenodd"
        ...
        {/* Các nét chữ Z-A-L-O bên trong: Sử dụng currentColor để ăn theo màu nền */}
