...
public class ManageTransactionStatisticsService {
    ...
    public ManageTransactionStatisticsResponse getTransactionDashboard(int days) {
        ...
        Long prevCashInObj = transactionRepository.sumAmountByTypeAndStatusAndDateBetween(TransactionType.DEPOSIT,
        ...
        // tich
        Long serviceUsageObj = transactionRepository.sumAmountByTypeAndStatusAndDateBetween(TransactionType.PAYMENT,
                TransactionStatus.SUCCESS, startDate, endDate);
        long serviceUsage = serviceUsageObj != null ? Math.abs(serviceUsageObj) : 0L;

        Long prevServiceUsageObj = transactionRepository.sumAmountByTypeAndStatusAndDateBetween(TransactionType.PAYMENT,
                TransactionStatus.SUCCESS, prevStartDate, prevEndDate);
        ...
        // 4. KPI: Ty le nap loi
        long totalDeposits = transactionRepository.countByTypeAndCreatedAtBetween(TransactionType.DEPOSIT, startDate,
                endDate);
        long failedDeposits = transactionRepository.countByTypeAndStatusAndCreatedAtBetween(TransactionType.DEPOSIT,
        ...
        List<Transaction> recentDepositEntities = transactionRepository
                .findTop5ByTypeOrderByCreatedAtDesc(TransactionType.DEPOSIT);
        ...
        return ManageTransactionStatisticsResponse.builder()
                ...
                .statusBreakdown(transactionRepository.getTransactionStatusBreakdown(startDate, endDate))
                .topSpenders(transactionRepository.getTopSpenders(startDate, endDate, PageRequest.of(0, 10)))
